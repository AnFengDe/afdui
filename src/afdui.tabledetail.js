    ...
    $
            .widget(
                    ...
                    $.ui.dialog,
                    {
                         ...
                         * @property {tableDetailButtons} buttons the form
                         *           buttons(new, save, delete, close)
                         * @property {tableDetailTable} table the table option
                         *           set
                         * @property {tableDetailForm} form the form definition,
                         *           not null, will be set according create
                         *           widget
                         */
                        ...
                        _setOptions : function() {
                            if (this.options.form === null && this.options.table === null) {
                                throw new Error('The table data or form data must be set in option.');
                            }
                        ...
                        /**
                         * create the table which the id is dataTbale,and create
                         * the div which the id is tableDiv
                         * <li>this function not accept any parameter</li>
                         * 
                         * @private
                         * @function
                        ...
                        /**
                         * Judgment form content is in line with the overall
                         * form of a combination of verification
                         * 
                         * @function
                         * @private
                         * 
                        ...
                        _formDataIsRight : function() {
                            if (typeof this.options.formValidator !== 'undefined') {
                        ...
                        /**
                         * Judging table in the content complies with the
                         * combination of the overall table validation
                         * 
                         * @function
                         * @private
                         * 
                        ...
                        _tableDataIsRight : function() {
                            if (typeof this.options.filedValidator !== 'undefined') {
                                if (typeof this.options.filedValidator(this.getData()) === 'string') {
                                    var html = '<div id = "tblDetailDialog"><p></p></div>';
                                    $(html).appendTo(this.element);
                                    $("#tblDetailDialog").dialog({
                                        close : function() {
                                    ...
                                    if ($('.afdui-td-input')[0].disabled === true) {
                                        ...
                                        $('#tblDetailDialog p')[0].innerHTML = this.options.filedValidator(this.getData());
                                        $('#tblDetailDialog').dialog();
                                    }
                                    return false;
                                }
                        ...
                        _buildInput : function(input) {
                            ...
                            if ("input" === input.type) {
                                ...
                                return '<input id="detail_' + input.id + '" class="afdui-td-input" type="' + input.format
                                        + '" maxlength="' + input.maxlength + '" size="' + input.size + '" '
                                        + (input.readonly ? 'readonly ' : '') + this._buildInputMessage(input.message) + '>';
                            }
                        ...
                        /**
                         * Sync content in the tabs within the element to the
                         * table
                         * 
                         * @private
                         * @function
                        ...
                        /**
                         * check the save message is save when close the dialog
                         * or click other tr
                         * 
                         * @private
                         * @function
